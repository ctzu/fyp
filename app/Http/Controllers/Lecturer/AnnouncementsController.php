...
class AnnouncementsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('role.lecturer.announcements.index', compact('announcements'));
    }
    ...
    {
        $clubs = Club::get();
        return view('role.lecturer.announcements.create', compact('clubs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pensyarah.hebahan.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('role.lecturer.announcements.show', compact('announcement'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('role.lecturer.announcements.edit', compact('clubs','announcement'));
    }
