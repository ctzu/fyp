...
<table class="table table-bordered" border="1" style="border-collapse: collapse; width: 80%; border-color: #adadad;">
    ...
    <tr>
        <td width="40%" style="text-align: right; font-size: 18px;padding: 10px;">Tempat Aktiviti : </td>
        <td width="60%" style="text-align: left; font-size: 18px; font-weight: bold; padding: 10px;"> {{ $activity->place}}</td>
    </tr>
    <tr>
        <td width="40%" style="text-align: right; font-size: 18px;padding: 10px;">Tarikh Aktiviti : </td>
        <td width="60%" style="text-align: left; font-size: 18px; font-weight: bold; padding: 10px;"> {{ $activity->date}}</td>
    </tr>
    <tr>
        <td width="40%" style="text-align: right; font-size: 18px;padding: 10px;">Peringkat Aktiviti : </td>
        <td width="60%" style="text-align: left; font-size: 18px; font-weight: bold; padding: 10px;"> {{ $activity->level->label}}</td>
    </tr>
    <tr>
        <td width="40%" style="text-align: right; font-size: 18px;padding: 10px;">Pencapaian : </td>
        <td width="60%" style="text-align: left; font-size: 18px; font-weight: bold; padding: 10px;"> {{ $activity->achievement->label}}</td>
    </tr>
    <tr>
