...
<div class="row">
    <div class="col-md-12">
        <form class="form-horizontal" action="{{ route('pelajar.hebahan.update', $announcement) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('nama_program') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input class="form-control" id="nama_program" type="text" name="nama_program" value="{{ old('nama_program', $announcement->title) }}">
            ...
            <div class="form-group {{ $errors->has('nama_kelab') ? 'has-error' : '' }}">
                ...
                <div class="col-md-3">
                    ...
                    @foreach($clubs as $club)
                        <option value="{{ $club->id }}" {{ setSelected($club->id, old('nama_kelab', $announcement->club_id)) }}>{{ $club->name }}</option>
                    @endforeach
            ...
            <div class="form-group {{ $errors->has('perincian') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <textarea  class="form-control" id="perincian" type="text" name="perincian" row="6">{{old('perincian', $announcement->description)}}</textarea>
            ...
            <div class="form-group {{ $errors->has('tempat_program') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input class="form-control" id="tempat_program" type="text" name="tempat_program" value="{{ old('tempat_program', $announcement->placeP) }}">
            ...
            <div class="form-group {{ $errors->has('tarikh_program') ? 'has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input class="form-control datepicker" id="tarikh_program" type="text" name="tarikh_program" value="{{ old('tarikh_program', $announcement->dateP) }}">
