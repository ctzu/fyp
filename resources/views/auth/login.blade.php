...
<div class="container">
    <div class="row">
        <div class="col-lg-5 col-md-offset-4">
                <img class="img-responsive" src="img/UKM.png" alt="">
        </div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> Ingati Saya
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <span class="glyphicon glyphicon-log-in"> Log Masuk</span>
                                </button>
